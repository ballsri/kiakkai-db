...
class LastNameWidget extends StatefulWidget {
  ...
  @override
  LastNameWidgetState createState() => LastNameWidgetState();
}

class LastNameWidgetState extends State<LastNameWidget> {
        ...
        Expanded(
          child: Padding(
            padding: const EdgeInsets.only(
                top: 10.0, left: 4.0), // Adjust the left padding here
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                errorText: _isInputValid ? null : 'กรุณากรอกนามสกุล',
              ),
              onChanged: (value) {
